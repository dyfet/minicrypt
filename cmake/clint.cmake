...
if(LINT_SOURCES)
    ...
    if(EXISTS "${CMAKE_SOURCE_DIR}/cmake/cppcheck.arg" AND CPPCHECK_EXEC)
        ...
        add_custom_target(cppcheck
            WORKING_DIRECTORY "${CMAKE_CURRENT_SOURCE_DIR}"
            USES_TERMINAL
            COMMAND ${CPPCHECK_EXEC} -I${PROJECT_BINARY_DIR} ${cppcheckArgs} --force --std=c${CMAKE_C_STANDARD} --quiet ${LINT_SOURCES}
        )
    endif()
    ...
    if(EXISTS "${CMAKE_SOURCE_DIR}/cmake/tidy.arg" AND CLANG_TIDY_EXEC)
        ...
        add_custom_target(lint_tidy
            WORKING_DIRECTORY "${CMAKE_CURRENT_SOURCE_DIR}"
            USES_TERMINAL
            COMMAND ${CLANG_TIDY_EXEC} ${LINT_SOURCES} -quiet -- -std=c${CMAKE_C_STANDARD} -I${PROJECT_BINARY_DIR}  ${tidyArgs}
        )
    endif()
endif()
